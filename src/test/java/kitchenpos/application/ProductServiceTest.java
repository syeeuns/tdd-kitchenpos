...
class ProductServiceTest {
  ...
  void SHOULD_success_WHEN_create_Product() {
    ...
    // 실행
    Product newbie = productService.create(product);

    //검증
    assertThat(newbie.getId()).isEqualTo(product.getId());
    assertThat(newbie.getPrice()).isEqualTo(product.getPrice());
    assertThat(newbie.getName()).isEqualTo(product.getName());
  }
